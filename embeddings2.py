    ...
    for iter_num in tqdm(iterations):
        ...
        with open(os.path.join(directory_path, 'Test.txt')) as f:
            ...
            for line in f:
                ...
                try:
                    print('trans dict', len(transcription_translation_dict))
...
def main():
    ...
    model.load_state_dict(torch.load('./weights_save/suturing_weights/suturing_512.pth'))
    ...
    labels_store_path = '../jigsaw_dataset/Surgeon_study_videos/multimodal_labels/multidata_512_labels.txt'
